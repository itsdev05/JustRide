            ...
            <div className="row">
              <div className="col-xl-4 col-md-4 mb-30">
                <div className="single-cta">
                  <div className="cta-text">
                    ...
                    <h4>Find us</h4>
                    <span>
                     vaniyavad circle, nadiad-387411,gujarat,india
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="col-xl-4 col-md-4 mb-30">
                ...
                <div className="single-cta">
                  <div className="cta-text">
                    <h4>Mail us</h4>
                    <span>bookyourcar@gmail.com</span>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div className="footer-logo">
                    <a href="#">
                      <img
                        ...
                        alt="logo"
                      />
                      <h3 style={{ color: "#00ffffdf", fontFamily:"sans-serif" }}>
                        JustRide
                      </h3>
                    </a>
                  </div>
